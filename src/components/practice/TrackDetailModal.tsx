...
function TrackDetailModal({ track, onClose, onStartPractice, onEditTrack }: TrackDetailModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-gray-950/70 p-6 backdrop-blur-sm"
      onClick={onClose}>
      <div
        role="dialog"
        aria-modal="true"
        ...
        className="relative flex max-h-[90vh] w-[672px] max-w-full flex-col overflow-y-auto rounded-[10px] border-[0.3px] border-gray-600 bg-gray-900 px-[59px] py-[42px]">
        <button
          type="button"
          onClick={onClose}
          aria-label="상세정보 닫기"
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div className="flex flex-wrap items-center gap-1.5">
              ...
              <span
                className={`caption-regular rounded-[6px] border-[0.5px] px-2 py-0.5 ${DIFFICULTY_COLOR[difficulty]}`}>
