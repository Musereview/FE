                ...
                <div className="ml-[24px] flex items-center gap-[4px]">
                  {scoreType === 'down' ? (
                    <>
                      ...
                      <span className="text-error text-[14px] leading-[20px] font-medium">{item.scoreChange}</span>
                    </>
                  ) : scoreType === 'up' ? (
                    <>
                      <svg
                    ...
                    <svg
                      ...
                      fill="none"
                      className="h-6 w-6 shrink-0">
                      <path d="M6 12H18" className="stroke-gray-400" strokeWidth="1.5" strokeLinecap="round" />
                    </svg>
                  )}
                </div>
              </div>
            ...
            <div className="flex shrink-0 items-center justify-between gap-4 md:justify-end md:gap-6">
              ...
              <div className="flex items-center gap-1.5 text-sm font-normal whitespace-nowrap text-gray-500 md:w-[150px]">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  className="shrink-0">
                  <circle cx="8" cy="8" r="6.5" className="stroke-gray-500" strokeWidth="1.2" />
