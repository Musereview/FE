...
//       {/* 1번 카드: 정확도 */}
//       <div
//         className="flex flex-1 flex-col border border-[#2E3142]"
//         style={{
//           display: 'flex',
//           padding: '24px',
...
//           전 주보다 <span className="text-[#9CFFD6]">4% 증가</span>했어요
//         </div>
//       </div>
...
//         </div>
//         <div className="text-[15px] font-normal text-[#868A91]">
//           전 주보다 <span className="text-[#9CFFD6]">18분 증가</span>했어요
//         </div>
//       </div>
...
//         </div>
//         <div className="text-[15px] font-normal text-[#868A91]">
//           전 주보다 <span className="text-[#9CFFD6]">2개 증가</span>했어요
//         </div>
//       </div>
//     </div>
//   );
...
// 1. 반복되는 카드를 깔끔하게 그려줄 공통 컴포넌트 추출
