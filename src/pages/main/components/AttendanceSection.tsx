    ...
    <div
      ...
      <div className="flex w-[280px] min-w-[280px] shrink-0 flex-col">
        <div className="flex items-baseline justify-between gap-4 pb-3">
          <span className="shrink-0 text-sm font-semibold text-[#69FFC0]">주간 연습 시간</span>
          <p className="text-[38px] leading-none font-bold text-[#69FFC0]">
        ...
        <div className="flex items-center justify-between gap-4 pt-3 text-sm">
          <span className="shrink-0 font-medium text-gray-300">{practiceSummary.monthLabel} 누적 연습 시간</span>
          <p className="font-semibold text-gray-300">{practiceSummary.monthlyPracticeHours}h</p>
        </div>
      </div>
    </div>
  );
